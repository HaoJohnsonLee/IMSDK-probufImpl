...
public class Protocals
{
	...
	public Protocals(int type, String dataContent, String from, String to)
	{
		this(type, dataContent, from, to, -1);
	}
	
	public Protocals(int type, String dataContent, String from, String to, int typeu)
	{
	...
	public Object clone()
	{
		Protocals cloneP = new Protocals(this.getType()
