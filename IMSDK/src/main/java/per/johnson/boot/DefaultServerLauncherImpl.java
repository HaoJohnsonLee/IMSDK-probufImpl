...
public class DefaultServerLauncherImpl extends ServerLauncher
{
    // 静态类方法：进行一些全局配置设置
    static
    {
...
//		BridgeProcessor.IMMQ_URI = "amqp://js:19844713@192.168.31.190";
    ...
    // 实例构造方法
    public DefaultServerLauncherImpl() throws IOException
    {
        super();
    }
    ...
    public static void start() throws Exception
    {
        ...
        final DefaultServerLauncherImpl sli = new DefaultServerLauncherImpl();
